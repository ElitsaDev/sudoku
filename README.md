...
# Features
The user can solve a random puzzle generated by the app by clicking the Load button. 
While the user solves the puzzle a timer counts down the elapsed time. If the user clicks on the Pause button, the puzzle will be hidden and the timer will stop at the current time.
